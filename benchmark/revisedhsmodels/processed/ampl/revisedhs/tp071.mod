...
var x_4 >= 1, <= 5;
let x_4 := 1;
var myminfun = x_1*x_4*(x_1 + x_2 + x_3) + x_3;
var myabsdevnod0_0 = abs(myminfun - 17.0140172891563);
var myreldevnod0_0 = abs(myminfun/17.0140172891563 - 1);
var myabsdevnod0_1 = abs(x_1 - 1);
var myreldevnod0_1 = abs(x_1 - 1);
var myabsdevnod0_2 = abs(x_2 - 4.742999637264417);
var myreldevnod0_2 = abs(x_2/4.742999637264417 - 1);
var myabsdevnod0_3 = abs(x_3 - 3.821149984184874);
var myreldevnod0_3 = abs(x_3/3.821149984184874 - 1);
var myabsdevnod0_4 = abs(x_4 - 1.379408293172672);
var myreldevnod0_4 = abs(x_4/1.379408293172672 - 1);
