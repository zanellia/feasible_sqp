...
var x_2;
let x_2 := 0.1;
var myminfun = (x_1 - 5)^2 + x_2^2 - 25;
var myabsdevnod0_0 = abs(myminfun + 8.498464223154677);
var myreldevnod0_0 = abs(myminfun/8.498464223154677 + 1);
var myabsdevnod0_1 = abs(x_1 - 1.234772825053297);
var myreldevnod0_1 = abs(x_1/1.234772825053297 - 1);
var myabsdevnod0_2 = abs(x_2 - 1.5246639294901);
var myreldevnod0_2 = abs(x_2/1.5246639294901 - 1);
