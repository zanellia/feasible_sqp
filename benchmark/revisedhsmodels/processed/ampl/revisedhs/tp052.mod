...
var x_5;
let x_5 := 2;
var myminfun = (4*x_1 - x_2)^2 + (x_2 + x_3 - 2)^2 + (x_4 - 1)^2 + (x_5 - 1)^2;
var myabsdevnod0_0 = abs(myminfun - 5.326647564469914);
var myreldevnod0_0 = abs(myminfun/5.326647564469914 - 1);
var myabsdevnod0_1 = abs(x_1 + 0.09455587392550143);
var myreldevnod0_1 = abs(x_1/0.09455587392550143 + 1);
var myabsdevnod0_2 = abs(x_2 - 0.03151862464183381);
var myreldevnod0_2 = abs(x_2/0.03151862464183381 - 1);
var myabsdevnod0_3 = abs(x_3 - 0.5157593123209169);
var myreldevnod0_3 = abs(x_3/0.5157593123209169 - 1);
var myabsdevnod0_4 = abs(x_4 + 0.4527220630372493);
var myreldevnod0_4 = abs(x_4/0.4527220630372493 + 1);
var myabsdevnod0_5 = abs(x_5 - 0.03151862464183381);
var myreldevnod0_5 = abs(x_5/0.03151862464183381 - 1);
