...
var x_2;
let x_2 := 2;
var myminfun = (x_1 - 2)^2 + (x_2 - 1)^2;
var myabsdevnod0_0 = abs(myminfun - 1.393464980689302);
var myreldevnod0_0 = abs(myminfun/1.393464980689302 - 1);
var myabsdevnod0_1 = abs(x_1 - 0.8228756555322953);
var myreldevnod0_1 = abs(x_1/0.8228756555322953 - 1);
var myabsdevnod0_2 = abs(x_2 - 0.9114378277661476);
var myreldevnod0_2 = abs(x_2/0.9114378277661476 - 1);
