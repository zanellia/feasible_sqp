...
var x_3;
let x_3 := 1;
var myminfun = -x_1*x_2*x_3;
var myabsdevnod0_0 = abs(myminfun + 22.62741699796952);
var myreldevnod0_0 = abs(myminfun/22.62741699796952 + 1);
var myabsdevnod0_1 = abs(x_1 - 4);
var myreldevnod0_1 = abs(x_1/4 - 1);
var myabsdevnod0_2 = abs(x_2 - 2.82842712474619);
var myreldevnod0_2 = abs(x_2/2.82842712474619 - 1);
var myabsdevnod0_3 = abs(x_3 - 2);
var myreldevnod0_3 = abs(x_3/2 - 1);
