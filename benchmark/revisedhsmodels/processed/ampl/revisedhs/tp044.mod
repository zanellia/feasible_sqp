...
var x_4 >= 0;
let x_4 := 0;
var myminfun = x_1 - x_2 - x_3 - x_1*x_3 + x_1*x_4 + x_2*x_3 - x_2*x_4;
var myabsdevnod0_0 = abs(myminfun + 15);
var myreldevnod0_0 = abs(myminfun/15 + 1);
var myabsdevnod0_1 = abs(x_1);
var myreldevnod0_1 = abs(x_1);
var myabsdevnod0_2 = abs(x_2 - 3);
var myreldevnod0_2 = abs(x_2/3 - 1);
var myabsdevnod0_3 = abs(x_3);
var myreldevnod0_3 = abs(x_3);
var myabsdevnod0_4 = abs(x_4 - 4);
var myreldevnod0_4 = abs(x_4/4 - 1);
