...
var myabsdevnod0_0 = abs(myminfun + 3456);
var myreldevnod0_0 = abs(myminfun/3456 + 1);
var myabsdevnod0_1 = abs(x_1 - 24);
var myreldevnod0_1 = abs(x_1/24 - 1);
var myabsdevnod0_2 = abs(x_2 - 12);
var myreldevnod0_2 = abs(x_2/12 - 1);
var myabsdevnod0_3 = abs(x_3 - 12);
var myreldevnod0_3 = abs(x_3/12 - 1);
