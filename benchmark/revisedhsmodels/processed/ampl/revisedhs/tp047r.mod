...
var x_5 >= lbx5;
let x_5 := 1/2;
var myminfun = (x_1 - x_2)^2 + (x_2 - x_3)^3 + (x_3 - x_4)^4 + (x_4 - x_5)^4;
var myabsdevnod0_0 = abs(myminfun + 0.02671418269394084);
var myreldevnod0_0 = abs(myminfun/0.02671418269394084 + 1);
var myabsdevnod0_1 = abs(x_1 - 0.6770043948666402);
var myreldevnod0_1 = abs(x_1/0.6770043948666402 - 1);
var myabsdevnod0_2 = abs(x_2 - 0.726089472652032);
var myreldevnod0_2 = abs(x_2/0.726089472652032 - 1);
var myabsdevnod0_3 = abs(x_3 - 1.215491214237097);
var myreldevnod0_3 = abs(x_3/1.215491214237097 - 1);
var myabsdevnod0_4 = abs(x_4 - 1.751329419235542);
var myreldevnod0_4 = abs(x_4/1.751329419235542 - 1);
var myabsdevnod0_5 = abs(x_5 - 1.477095285617732);
var myreldevnod0_5 = abs(x_5/1.477095285617732 - 1);
