...
var x_2 >= -3, <= 3;
let x_2 := 0;
var myminfun = sin(x_1 + x_2) + (x_1 - x_2)^2 - 1.5*x_1 + 2.5*x_2 + 1;
var myabsdevnod0_0 = abs(myminfun + 1.913222954981036);
var myreldevnod0_0 = abs(myminfun/1.913222954981036 + 1);
var myabsdevnod0_1 = abs(x_1 + 0.5471975511965977);
var myreldevnod0_1 = abs(x_1/0.5471975511965977 + 1);
var myabsdevnod0_2 = abs(x_2 + 1.547197551196598);
var myreldevnod0_2 = abs(x_2/1.547197551196598 + 1);
