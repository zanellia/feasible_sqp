...
var x_4;
let x_4 := 1;
var myminfun = (x_1 - 1)^2 + (x_2 - 2)^2 + (x_3 - 3)^2 + (x_4 - 4)^2;
var myabsdevnod0_0 = abs(myminfun - 13.85786437626905);
var myreldevnod0_0 = abs(myminfun/13.85786437626905 - 1);
var myabsdevnod0_1 = abs(x_1 - 2);
var myreldevnod0_1 = abs(x_1/2 - 1);
var myabsdevnod0_2 = abs(x_2 - 2);
var myreldevnod0_2 = abs(x_2/2 - 1);
var myabsdevnod0_3 = abs(x_3 - 0.848528137423857);
var myreldevnod0_3 = abs(x_3/0.848528137423857 - 1);
var myabsdevnod0_4 = abs(x_4 - 1.131370849898476);
var myreldevnod0_4 = abs(x_4/1.131370849898476 - 1);
