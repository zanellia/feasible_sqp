...
var x_4 >= 0;
let x_4 := 0.5;
var myminfun = x_1^2 + 0.5*x_2^2 + x_3^2 + 0.5*x_4^2 - x_1*x_3 + x_3*x_4 - x_1 - 3*x_2 + x_3 - x_4;
var myabsdevnod0_0 = abs(myminfun + 4.681818181818182);
var myreldevnod0_0 = abs(myminfun/4.681818181818182 + 1);
var myabsdevnod0_1 = abs(x_1 - 0.2727272727272727);
var myreldevnod0_1 = abs(x_1/0.2727272727272727 - 1);
var myabsdevnod0_2 = abs(x_2 - 2.090909090909091);
var myreldevnod0_2 = abs(x_2/2.090909090909091 - 1);
var myabsdevnod0_3 = abs(x_3);
var myreldevnod0_3 = abs(x_3);
var myabsdevnod0_4 = abs(x_4 - 0.5454545454545455);
var myreldevnod0_4 = abs(x_4/0.5454545454545455 - 1);
