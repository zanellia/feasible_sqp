...
var x_2 >= 0, <= 50;
let x_2 := 2;
var myminfun = (1/100)*x_1^2 + x_2^2;
var myabsdevnod0_0 = abs(myminfun - 5);
var myreldevnod0_0 = abs(myminfun/5 - 1);
var myabsdevnod0_1 = abs(x_1 - 15.8113883008419);
var myreldevnod0_1 = abs(x_1/15.8113883008419 - 1);
var myabsdevnod0_2 = abs(x_2 - 1.58113883008419);
var myreldevnod0_2 = abs(x_2/1.58113883008419 - 1);
