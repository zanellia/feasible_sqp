...
var myabsdevnod0_0 = abs(myminfun + 3300);
var myreldevnod0_0 = abs(myminfun/3300 + 1);
var myabsdevnod0_1 = abs(x_1 - 20);
var myreldevnod0_1 = abs(x_1/20 - 1);
var myabsdevnod0_2 = abs(x_2 - 11);
var myreldevnod0_2 = abs(x_2/11 - 1);
var myabsdevnod0_3 = abs(x_3 - 15);
var myreldevnod0_3 = abs(x_3/15 - 1);
