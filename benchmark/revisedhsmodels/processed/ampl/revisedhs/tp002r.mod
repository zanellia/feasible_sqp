...
var myabsdevnod0_0 = abs(myminfun - 0.05042618789360708);
var myreldevnod0_0 = abs(myminfun/0.05042618789360708 - 1);
var myabsdevnod0_1 = abs(x_1 - 1.224370748736353);
var myreldevnod0_1 = abs(x_1/1.224370748736353 - 1);
var myabsdevnod0_2 = abs(x_2 - 1.5);
var myreldevnod0_2 = abs(x_2/1.5 - 1);
