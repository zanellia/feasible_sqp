...
var myabsdevnod0_0 = abs(myminfun - 3.190336744264742);
var myreldevnod0_0 = abs(myminfun/3.190336744264742 - 1);
var myabsdevnod0_1 = abs(x_1 + 0.7861513777574233);
var myreldevnod0_1 = abs(x_1/0.7861513777574233 + 1);
var myabsdevnod0_2 = abs(x_2 - 0.6180339887498948);
var myreldevnod0_2 = abs(x_2/0.6180339887498948 - 1);
