...
var x_5;
let x_5 := 2;
var myminfun = (x_1 - 1)^2 + (x_1 - x_2)^2 + (x_2 - x_3)^2 + (x_3 - x_4)^4 + (x_4 - x_5)^4;
var myabsdevnod0_0 = abs(myminfun - 0.0787768208710569);
var myreldevnod0_0 = abs(myminfun/0.0787768208710569 - 1);
var myabsdevnod0_1 = abs(x_1 - 1.191127456311051);
var myreldevnod0_1 = abs(x_1/1.191127456311051 - 1);
var myabsdevnod0_2 = abs(x_2 - 1.362603164961742);
var myreldevnod0_2 = abs(x_2/1.362603164961742 - 1);
var myabsdevnod0_3 = abs(x_3 - 1.472817931512088);
var myreldevnod0_3 = abs(x_3/1.472817931512088 - 1);
var myabsdevnod0_4 = abs(x_4 - 1.635016619167993);
var myreldevnod0_4 = abs(x_4/1.635016619167993 - 1);
var myabsdevnod0_5 = abs(x_5 - 1.679081436166408);
var myreldevnod0_5 = abs(x_5/1.679081436166408 - 1);
