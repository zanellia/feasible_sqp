...
var x_2;
let x_2 := 0;
var myminfun = (1/2)*x_1^2 + x_2^2 - x_1*x_2 - 7*x_1 - 7*x_2;
var myabsdevnod0_0 = abs(myminfun + 30);
var myreldevnod0_0 = abs(myminfun/30 + 1);
...
subject to ci_1: 25 - 4*x_1^2 - x_2^2 >= 0;
solve;
display x_1;
display x_2;
display myminfun;
