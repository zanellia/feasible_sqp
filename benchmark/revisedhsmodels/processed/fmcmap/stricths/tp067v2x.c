...
tp067v2x (fmc_type_tcb *tcb, fmc_type_float funcode, fmc_type_float diffcode,
...

{
  ...
  if (diffcode < (-0.5e+0))
      ...
      y = tp067v2xf (tcb, funcode, x1, x2, x3);
    else if (diffcode < 1.5e+0)
      y = tp067v2xd (tcb, funcode, 1, x1, x2, x3);
    else if (diffcode < 2.5e+0)
      y = tp067v2xd (tcb, funcode, 2, x1, x2, x3);
    else if (diffcode < 3.5e+0)
      y = tp067v2xd (tcb, funcode, 3, x1, x2, x3);
    else
      y = fmc_m_notafloat ();
...
static fmc_type_float
tp067v2xf (fmc_type_tcb *tcb, fmc_type_float funcode, fmc_type_float x1,
...
static fmc_type_float
tp067v2xd (fmc_type_tcb *tcb, fmc_type_float funcode, fmc_type_uint diffcode,
            fmc_type_float x1, fmc_type_float x2, fmc_type_float x3)
