Model tp068r2
  ...
  ! This is a formulation of #68r that does not need erfc().
  ...
  ! differentiation. For the reference values, FMC better executes tp068r3.
  ...
  Equations
    ...
    ! x[1] = 0.06785857708551205
    ! x[2] = 3.646210855688194
    ! x[3] = 0.0002661356252153867
    ! x[4] = 0.8948550393735502
