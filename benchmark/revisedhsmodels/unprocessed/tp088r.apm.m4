Model tp088r
  ...
  ! one such that there is some minor uniqueness support.
  ...
  Intermediates
    ...
    rhoaux[2][1:30] = 1*emx[1][1:30]*emx[2][1:30] &
                    - 2*emx[2][1:30] &
                    + 1
    rho[1:30] = (-1)*rhoaux[2][1:30]/mu[1:30]^2
    aux1[1:30] = A[1:30]^2*rhoaux[2][1:30]^2
